...
class MainLayout(Widget):
    ...
    def update_input_spinner_vals(self, selected_text): # Spinner Handle
        ##### ============ Use Different Approach for Sub Menu Selction ============ #####
        ##### ============ The one written at the end is getting triggered ============ #####
        ...
        elif selected_text in self.major_minor_options: # Select Capo Position (Not Coming in GUI)
        ...
        else: # For no inner lists (But getting triggered for sub-menu selection)
            self.input_spinner_vals = tuple(self.notes)
        ...
        ## Auto-Show Output in Output-Area on displaying self.notes/'m' in Input_Menu
    ...
    def reset(self): # Reset Application
